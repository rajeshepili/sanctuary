...
export type JournalMood = NonNullable<
  (typeof journalEntries.$inferSelect)['mood']
>
...
export type Identity = Habit
export type IdentityCompletion = HabitCompletion
export type IdentityCategory = HabitCategoryEntity

export type HabitsData = {
  habits: Habit[]
  completions: HabitCompletion[]
}
export type IdentitiesData = HabitsData
