...
export async function findById(data: GetEntryInput): Promise<Entry | null> {
  const db = await getDb()
...
export async function create(data: CreateEntryInput): Promise<Entry> {
  const db = await getDb()
...
export async function update(data: UpdateEntryInput): Promise<Entry> {
  const db = await getDb()
  const trimmed = data.content.trim()
...
export async function remove(data: DeleteEntryInput): Promise<void> {
  const db = await getDb()
...
export async function restore(id: number): Promise<{ id: number }> {
  const db = await getDb()
