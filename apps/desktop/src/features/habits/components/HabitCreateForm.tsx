    ...
    >
      ...
      <FieldGroup className="gap-3 mb-5">
        <form.Field
          ...
          children={(field) => (
            <Field>
              <FieldLabel htmlFor={field.name} className="text-xs font-semibold">
        ...
        <form.Field
          name="name"
          validators={{ onSubmit: ({ value }) => (!value.trim() ? 'Daily action is required' : undefined) }}
          children={(field) => (
                ...
                children={(countField) => (
                  <form.Field
                    ...
                    children={(intervalField) => {
                      ...
                      const showDayPicker =
                        freq === 'weekly' || freq === 'custom' || freq === 'monthly'
                              ...
                              >
                                ...
                                <div className="flex flex-wrap gap-1.5">
                                  {WEEKDAYS.map((day) => (
                                    <DayChip
                                      key={day.value}
                                      active={daysField.state.value.includes(day.value)}
                                      onClick={() => {
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
            ...
            <Field>
              ...
              <div className="flex gap-1.5">
                {PRIORITIES.map((p) => (
                  ...
                  >
                    <span
                      className={cn('inline-block w-1.5 h-1.5 rounded-full mr-1.5', p.dot)}
                    />
                    {p.label}
                  </ToggleChip>
                ))}
        ...
        <form.Field
          ...
          children={(field) => (
            <Field>
              <FieldLabel className="text-xs font-semibold">Category</FieldLabel>
              <Select
                value={field.state.value?.toString() ?? ''}
                onValueChange={(v) => field.handleChange(v ? parseInt(v) : null)}
              >
