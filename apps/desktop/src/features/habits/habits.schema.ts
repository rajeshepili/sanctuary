...
// Identity-facing aliases (backed by the same schema).
export type CreateIdentityInput = CreateHabitInput
export type UpdateIdentityInput = UpdateHabitInput
export type UpdateIdentityStatusInput = UpdateHabitStatusInput
export type DeleteIdentityInput = DeleteHabitInput
export type ToggleIdentityCompletionInput = ToggleCompletionInput
