  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'data-[state=active]:bg-primary/10 data-[state=active]:text-primary data-[state=active]:font-semibold data-[state=active]:shadow-sm data-[state=active]:border data-[state=active]:border-primary/20 dark:data-[state=active]:bg-primary/15 dark:data-[state=active]:text-foreground',
