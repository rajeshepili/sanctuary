  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 flex justify-center pb-8 pointer-events-none">
      <nav
        ...
        className="pointer-events-auto flex items-center justify-between gap-4 px-6 py-2.5 rounded-full border border-border/20 bg-background/80 backdrop-blur-xl shadow-lg w-auto"
      >
