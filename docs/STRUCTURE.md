...
│   │   ├── src/
│   │   │   ├── features/     # journal, identities (`habits` storage), preferences, export, …
...
Identity categories currently live in `features/habits/subdomains/categories/` for backward-compatible storage naming.
