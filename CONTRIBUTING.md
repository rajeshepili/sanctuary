...
│   │   └── main.ts
│   └── website/            # Astro landing (submodule)
...
Draft audits and architecture notes live in [`docs/internal/`](docs/internal/). They are not required reading for contributors.

## Reporting bugs

Include OS, Node version, desktop vs `pnpm dev`, steps to reproduce, expected vs actual behavior, and logs (no journal content unless you are okay sharing it).
